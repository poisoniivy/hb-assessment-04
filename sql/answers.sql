...
WHERE m.brand_id='for' AND m.name='Mustang';
...
SELECT COUNT(*) FROM models AS m JOIN brands AS b ON m.brand_id=b.brand_id WHERE b.name='Ford' GROUP BY b.name;
...
SELECT models.year, models.name, models.model_id, awards.name FROM models LEFT JOIN awards ON model_id=winner_id WHERE models.year >= 1964;
...
SELECT b.name,
  ...
  FROM brands AS b
    LEFT JOIN models AS m
      ON b.brand_id = m.brand_id WHERE m.name IS NOT NULL
  ORDER BY b.name;
